...
import { SELL_FORM } from '../../payload-model';

@Component({
  selector: 'app-sell-flow',
  imports: [
    CommonModule,
    ReactiveFormsModule,
    FormsModule,
  ...
  templateUrl: './sell-flow.component.html',
  styleUrl: './sell-flow.component.scss'
})
export class SellFlowComponent {
  ...
  submitForm() {
    if (this.buyForm.valid) {
      ...
      this.http.submitSellForm(data).then((res: any) => {
