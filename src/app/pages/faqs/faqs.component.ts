  ...
  faqData = [
    {
      ...
      faqs: [
        ...
        { question: "Is RealBucs available in my area?", answer: "Yes — RealBucs is available in all 50 U.S. states and Washington, D.C.<br><br>We work with a nationwide network of top-rated, vetted real estate agents and service providers. No matter where you're buying or selling, we can match you with trusted local professionals and help you access exclusive savings.<br><br>To get started, simply enter your ZIP code and we’ll show you what options and partner agents are available in your area — with no cost or obligation." }
      ]
    },
    {
      topic: 'Home sellers',
